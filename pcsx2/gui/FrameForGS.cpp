...
void GSPanel::InitDefaultAccelerators()
{
	...
	m_Accels->Map( AAC( wxKeyCode('r') ).Cmd(),			"Sys_SuspendResume" );
	m_Accels->Map( AAC( wxKeyCode('s') ).Cmd(),				"Sys_TakeSnapshot" ); // also shift, ctrl, and ctrl-shift will be added automatically
