...
void GSPanel::InitDefaultAccelerators()
{
	...
	m_Accels->Map( AAC( wxKeyCode('r') ),			"Sys_SuspendResume" );
	m_Accels->Map( AAC( wxKeyCode('s') ),				"Sys_TakeSnapshot" ); // also shift, ctrl, and ctrl-shift will be added automatically
